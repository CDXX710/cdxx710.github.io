...
!(function (e, t) {
	...
	function o(e, t) {
		var r = t.id,
			...
			i = a(e, t)
		return null == r && null == n ? {type: "Feature", properties: o, geometry: i} : null == n ? {type: "Feature", id: r, properties: o, geometry: i} : {type: "Feature", id: r, bbox: n, properties: o, geometry: i}
	}
	function a(e, t) {
		var n = r(e.transform),
			o = e.arcs
		...
		(e.quantize = function (e, t) {
			...
			if (t && t.scale) u = e.bbox
				...
				var r,
					...
					i = u[2],
					c = u[3]
				t = {scale: [i - o ? (i - o) / (r - 1) : 1, c - a ? (c - a) / (r - 1) : 1], translate: [o, a]}
			}
			var u,
				f,
				l = s(t),
