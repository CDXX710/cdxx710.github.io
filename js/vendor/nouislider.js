// https://github.com/leongersen/noUiSlider v15.7.0 Copyright 2019 Léon Gersen
!(function (t, e) {
	...
	function j(t, f, o) {
		...
		function B(t, e) {
			...
			e.handleNumbers.some(A) ||
				...
				t.stopPropagation(),
				(n = z(c.move, y, R, {target: t.target, handle: o, connect: e.connect, listeners: (r = []), startCalcPoint: t.calcPoint, baseSize: j(), pageOffset: t.pageOffset, handleNumbers: e.handleNumbers, buttonsProperty: t.buttons, locations: m.slice()})),
