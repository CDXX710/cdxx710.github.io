...
-   [ ] **No feedback when markers disappear.** Applying filters or changing the year range causes markers to vanish without explanation. Users should receive clear feedback (for example, "12 records hidden by filters") so changes in the dataset are understandable.
...
-   [x] **Getting rid of external libraries imports.**
